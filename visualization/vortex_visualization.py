...
def run_visualization_demo():
    ...
    # 1. Run simulation with STABLE parameters
    # Use larger domain and lower Re for stability
    print("\n1. Running Re=40 simulation (stable parameters)...")
    nx, ny = 300, 80
    cx, cy, r = 60, 40, 8
    re = 40
    ...
    solver = SimpleCylinderSolver(nx, ny, cx, cy, r, re=re, u_inlet=u_inlet)
    print(f"   tau={solver.tau:.4f}, should be > 0.52 for stability")
    ...
    for step in range(30000):
        ...
        if (step + 1) % 200 == 0:
            # Compute force (control volume method)
    ...
    plot_flow_field(solver, 'results/figures/flow_field_re40.png', f'(Re={re})')
    
    # 3. Create drag/lift plot
    print("\n3. Creating force coefficient plot...")
    create_drag_lift_plot(solver, 'results/figures/force_coefficients.png')
    
    # 4. Create publication figure with stable Re=40
    print("\n4. Creating publication figure...")
    create_publication_figure_stable('results/figures/vortex_development.png')
    
    # 5. Create animation with stable parameters
    print("\n5. Creating animation...")
    create_vortex_animation_stable(save_path='results/animations/vortex_shedding.gif')
    
    print("\n" + "=" * 60)
    print("Visualization Complete!")
    print("=" * 60)
    print("\nGenerated files:")
    print("  - results/figures/flow_field_re40.png")
    print("  - results/figures/force_coefficients.png")
    print("  - results/figures/vortex_development.png")
    print("  - results/animations/vortex_shedding.gif")
